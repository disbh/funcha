...
class Preloader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <div class="w-screen z-[1000] h-screen top-0 left-0 absolute grid items-center justify-center transition-all ease-[cubic-bezier(0.64,_0,_0.78,_0)] duration-500 bg-black" id="preloader">
